...
public class UpdatePatientCommandTest extends CommandTest {

    @Test
    public void adminUpdatePatient() throws Exception {
        ...
        when(request.getParameter("patientId")).thenReturn("90");
        ...
        assertNotNull(new UpdatePatientCommand().execute(request, response));
    ...
    @Test
    public void doctorUpdatePatient() throws Exception {
